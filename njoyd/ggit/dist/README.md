...
- 可通过 `ggit push|merge|fix -h` 查看帮助文档，查看子命令支持参数
  ...
  Options:
    ...
    -s, --stash [type]   使用 stash 暂存区方式合并代码，如果手动终止了脚本，需要使用 $ git stash pop 放出暂存区的代码，以免丢失 (default: true)
...
- 子命令参数介绍
  ...
  | -s, --stash \[type]  | 使用 stash 暂存区方式合并代码，如果手动终止了脚本，需要使用 \$ git stash pop 放出暂存区的代码，以免丢失 | 0/1/true/false/Ture/False | true                |
